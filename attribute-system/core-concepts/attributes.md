...
Attributes are defined in the **DT\_AttributeDefinitions** DataTable. Each row represents one attribute and contains all configuration for that attribute's behaviour including decay rate, recovery rate, drift settings and more.
